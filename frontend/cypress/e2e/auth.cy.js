describe("Tela de login", () => {
  ...
  it("rejeita login com credenciais inválidas", () => {
    // Nenhum backend real roda neste job do CI (só o preview estático do
    // frontend) — interceptamos a chamada para simular o backend recusando
    // as credenciais, em vez de depender de uma requisição de rede que não
    // tem para onde ir.
