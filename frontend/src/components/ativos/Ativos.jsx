...
const Ativos = () => {
  ...
  // Função para toggle da fatia da pizza
  ...
  // Handler para clique na legenda da pizza
  ...
  // Handler para clique na barra (via Cell)
  ...
  // Handler para clique na legenda da barra
    ...
    <div className="max-w-6xl mx-auto p-3 sm:p-4 pb-24">
      ...
      {ativos.length === 0 ? (
        ...
        <>
          ...
          {maiorAtivo && (
            <div className="card bg-gradient-to-r from-primary-50 to-blue-50 dark:from-primary-900/20 dark:to-blue-900/20 mb-4 sm:mb-6 p-3 sm:p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            {/* Gráfico 2: Top 5 Ativos - BARRA HORIZONTAL */}
            <div className="card p-3 sm:p-4">
              <div className="flex flex-wrap justify-between items-center gap-2 mb-3 sm:mb-4">
                <h2 className="text-sm sm:text-lg font-semibold">
                  Top 5 Ativos
