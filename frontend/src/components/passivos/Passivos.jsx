      ...
      {passivos.length === 0 ? (
        ...
        <>
          ...
          <div className="card p-2 sm:p-4">
            ...
            {/* Card de Total */}
            <div className="mt-3 p-2 sm:p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800 flex flex-wrap justify-between items-center gap-2">
              <span className="font-bold text-gray-700 dark:text-gray-300">
                TOTAL
              </span>
              <div className="flex flex-wrap gap-3 sm:gap-6 text-[10px] sm:text-sm">
                <span>Qtd: {passivos?.length || 0}</span>
                <span className="text-red-600 font-medium">
                  Total: {formatarMoeda(totalPassivos)}
                </span>
